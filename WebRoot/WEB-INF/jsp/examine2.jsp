...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="layui-body">
	  ...
	  <ul class="layui-tab-title">
	    <li><a href="examine1.jsp">会议室审批</a></li>
	    <li class="layui-this"><a href="examine2.jsp">请假审批</a></li>
	    <li><a href="examine3.jsp">出差审批</a></li>
	    <li><a href="examine4.jsp">费用审批</a></li>
	  </ul>
			  ...
			  <table class="layui-table">
			    ...
			    <tbody>
			      <tr>
			        ...
			        <td>
			        	<a href="#"><button class="layui-btn layui-btn-primary layui-btn-sm">同意</button></a>
			        	<a href="#"><button class="layui-btn layui-btn-primary layui-btn-sm">驳回</button></a>
					</td>
			      </tr>
			      <tr>
			        <td>某某</td>
