...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="layui-body">
	  ...
	  <ul class="layui-tab-title">
	    ...
	    <li class="layui-this"><a href="attendance2.jsp">出差申请</a></li>
	    <li><a href="attendance3.jsp">请假申请</a></li>
	  ...
	  <div class="layui-tab-content" style="height: 100px;">
	    ...
	    <div class="layui-tab-item  layui-show" >
	    	...
	    	<form class="layui-form" action="">
			  ...
			  <div class="layui-form-item">
			    <label class="layui-form-label">出差时间</label>
			    <div class="layui-input-block">
			  ...
			  <div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入出差地址" class="layui-input">
			    </div>
			  </div>
			  <div class="layui-form-item layui-form-text">
			    <label class="layui-form-label">出差事项</label>
			    <div class="layui-input-block">
			      <textarea placeholder="请输入事项" class="layui-textarea"></textarea>
			    </div>
			  </div>
			  <div class="layui-form-item">
			    <div class="layui-input-block">
